...
Consult the [typography reference](references/typography.md) from the frontend-design skill for detailed guidance on scales, pairing, and loading strategies.
