---
name: Personas
description: Five user persona archetypes for design testing — impatient executive, non-technical elder, power user, accessibility-dependent, and first-time visitor.
---
...
If `.cursorrules` contains a `## Design Context` section (generated by `teach-impeccable`), derive 1–2 additional personas from the audience and brand information:
