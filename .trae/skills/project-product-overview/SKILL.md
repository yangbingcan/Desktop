...
2. 读取 `templates/project/product-overview-template.md` 作为生成基准。
3. 填好后保存为 `docs/系统概述/产品概述.md`。
...
- **最终交付**：当文档内容被用户确认后，请将其保存到 `docs/系统概述/产品概述.md`，然后**自动生成UI设计规范**。
