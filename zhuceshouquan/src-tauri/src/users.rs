...
#[tauri::command]
pub fn get_users(db: tauri::State<'_, DbState>, token: String, params: GetUsersParams) -> Result<GetUsersResult, String> {
...
#[tauri::command]
pub fn create_user(db: tauri::State<'_, DbState>, token: String, params: CreateUserParams) -> Result<CreateUserResult, String> {
...
#[tauri::command]
pub fn update_user(db: tauri::State<'_, DbState>, token: String, params: UpdateUserParams) -> Result<UserItem, String> {
    let conn = get_conn(&db)?;
...
#[tauri::command]
pub fn delete_user(db: tauri::State<'_, DbState>, token: String, id: String) -> Result<(), String> {
    let conn = get_conn(&db)?;
...
#[tauri::command]
pub fn toggle_user_status(db: tauri::State<'_, DbState>, token: String, params: ToggleUserStatusParams) -> Result<(), String> {
    let conn = get_conn(&db)?;
...
#[tauri::command]
pub fn reset_user_password(db: tauri::State<'_, DbState>, token: String, params: ResetPasswordParams) -> Result<(), String> {
    let conn = get_conn(&db)?;
